...
// lưu biến prod-tab__item , prod-tab__item--current ,  prod-tab__content , prod-tab__content--current
// querySelector TABS
// sự kiện click vào tab
//      - querySelector prod-tab__item--current    -> remove class prod-tab__item--current
//      - querySelector prod-tab__content--current -> remove class prod-tab__content--current
//      - thêm class prod-tab__item--current vào tab được click
//      - thêm class prod-tab__content--current vào phần tử tại vị trí index trong mảng contents
